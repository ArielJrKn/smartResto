...
<head>
	...
	<body>
		<div class="flex h-screen bg-[#102C26] overflow-hidden">
	        ...
	        <!-- Sidebar -->
	        <div class="w-64 pt-10 flex flex-col hidden lg:block overflow-y-auto">
	            <nav class="flex-1 p-4">
	                <ul class="space-y-2">
	                    ...
	                    <li><a href="{{route('table')}}" class="flex items-center p-3 text-gray-700 dark:text-gray-300 hover:bg-white/30 rounded-lg">
	                    ...
	                    <li><a href="{{route('setting')}}" class="flex items-center p-3 text-gray-700 dark:text-gray-300 hover:bg-white/30 rounded-lg">
