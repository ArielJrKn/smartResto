	            ...
	            <main class="pt-20 flex-1 items-center justify-center flex-col overflow-y-auto p-6">
					<div class=" px-2 py-4">
				        <div class="flex items-center justify-between">
				            <div class="flex items-center gap-4">
				                <h1 class="text-2xl font-semibold text-white">Modifier une table</h1>
				            </div>
				    ...
				    <div class="flex min-h-[calc(100vh-80px)] w-full">
				        ...
				        <div class="flex-1 p-2">
				            <form class="max-w-2xl mx-auto" action="{{route('updateTable', $table)}}" method="POST">
				            	@csrf
				            	@method('PATCH')
				                ...
				                <div class="form-step active bg-white/10 rounded-xl shadow-sm p-8">
				                    ...
				                    <div class="space-y-6">
				                        ...
				                        <div>
				                            ...
				                            <input type="text" name="number" value="{{$table->number}}" id="tableNumber" placeholder="12" class="w-full px-4 py-3 bg-white/10 outline-none rounded-lg focus:ring-2 focus:ring-primary focus:border-primary text-sm">
				                            @error('number')
				                        ...
				                        <div>
				                            ...
				                            <input type="text" name="libelle" value="{{$table->libelle}}" id="tableName" placeholder="Table ronde" class="w-full px-4 py-3 bg-white/10 outline-none rounded-lg focus:ring-2 focus:ring-primary focus:border-primary text-sm">
				                            @error('libelle')
				                            	<p class="text-red-500">{{$message}}</p>
				                            @enderror
				                        </div>
				                        ...
				                        <div>
				                            ...
				                            <div class="flex items-center gap-3">
				                                ...
				                                <input name="places" value="{{$table->places}}" type="number" id="capacity" value="4" min="2" max="12" class="text-gray-400 capacity-input w-20 px-3 py-2 text-center bg-white/10 outline-none rounded-lg focus:ring-2 focus:ring-primary focus:border-primary text-sm">
				                ...
				                <div class="form-step bg-white/10 rounded-xl shadow-sm p-8">
				                    ...
				                    <div class="space-y-6">
				                        ...
				                        <div>
				                            ...
				                            <textarea name="notes" value="{{$table->notes}}" id="tableNotes" rows="4" placeholder="Idéal pour couples, vue fenêtre, proche de la cuisine..." class="w-full px-4 py-3 bg-white/10 outline-none rounded-lg focus:ring-2 focus:ring-primary focus:border-primary text-sm resize-none"></textarea>
				                        </div>
				                    </div>
				                </div>
