			                ...
			                <div class="flex items-start justify-between mb-4">
			                    <div class="flex-1">
			                        ...
			                        <div class="flex items-center gap-3 mb-2">
			                            ...
			                            <span class="px-3 py-1 bg-orange-100 text-orange-800 text-sm font-medium rounded-full">{{$product->type}}</span>
			                        </div>
			                    </div>
			                </div>
			            </div>
			            ...
			            <div class="grid grid-cols-1 lg:grid-cols-5 gap-8">
			                ...
			                <div class="lg:col-span-2">
			                    ...
			                    <div class="bg-white/10 rounded-lg p-6 mb-6">
			                        ...
			                        <div class="space-y-4">
			                            <div>
			                                <div class="text-3xl font-bold text-white mb-1">{{$product->price}} €</div>
			                        ...
			                        <div class="space-y-4">
			                            ...
			                            <div class="flex justify-between items-center">
			                           	...
			                           	<div class="flex justify-between items-center">
			                                ...
			                                <span class="text-sm text-white">{{$product->type}}</span>
			                            </div>

			                            <div class="flex justify-between items-center">
			                                <span class="text-sm text-gray-300">Temps de préparation</span>
			                                <span class="text-sm text-white">{{$product->time}} minutes</span>
			                            </div>
			                        </div>
			                    </div>
